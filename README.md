...
## Modes of Operation
`Base64.setMode` can be called to change Base64 to operate in 4 different write modes:

Features|`normal`|`urlsafe`|`performance`|`security`
-------:|-----|-------|------------|-------
<b>Charater Set| A-z, 0-9, +/=| A-z, 0-9, ~_-|normal|normal</b>
<b>Compression</b>|optimized|optimized|never|always
<b>Primes</b>|996 bit|996 bit|996 bit| 2140 bit

Example:
```javascript
Base64.setMode('urlsafe');
var queryParam = Base64.write(myUrlQueryParameter);

Base64.setMode('normal');
Base64.write(someOtherOperation);

Base64.read(queryParam); //I can still read this even though I'm in 'normal' mode
```
